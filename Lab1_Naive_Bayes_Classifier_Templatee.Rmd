...
naiveBayes <- setRefClass("naiveBayes",
       ...
       fields = c(prob_lovecraft, prob_edgardpoe, prog_Wollstonecraft),
       methods = list(
                    ...
                    {
                      count_tidy <<- train_data %>% count(splitted,sort=TRUE)
                      ...
                      tidy_lovecraft <- tidy_text %>% filter(tidy_text$label=="HP Lovecraft")
